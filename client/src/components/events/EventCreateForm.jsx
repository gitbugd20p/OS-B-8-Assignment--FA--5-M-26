...
const EventCreateForm = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const res = await axios.post("/api/v1/CreateEvent", payload);
			...
			<form onSubmit={handleSubmit}>
				<div className="row">
					<div className="mb-3 col-md-6">
						...
						<input type="text" name="title" required className="form-control" value={formData.title} onChange={handleChange} />
					</div>
				...
				<div className="mb-3">
					...
					<textarea name="description" required className="form-control" rows="3" value={formData.description} onChange={handleChange}></textarea>
				</div>
				...
				<div className="row">
					...
					<div className="mb-3 col-md-6 d-flex align-items-end">
						<div className="form-check">
							<input type="checkbox" className="form-check-input" id="isOnline" name="isOnline" checked={formData.isOnline} onChange={handleChange} />
				...
				<div className="row">
					...
					<div className="mb-3 col-md-6">
						...
						<input type="number" name="totalSeats" className="form-control" value={formData.totalSeats} onChange={handleChange} />
					</div>
				</div>
				...
				<div className="row">
					<div className="mb-3 col-md-6">
						...
						<input type="text" name="organizer" className="form-control" value={formData.organizer} onChange={handleChange} />
					</div>

					<div className="mb-3 col-md-6">
						<label className="form-label">Image URL</label>
						<input type="text" name="img" required className="form-control" value={formData.img} onChange={handleChange} />
					</div>
				</div>

				<div className="mb-3">
					<label className="form-label">Tags (comma separated)</label>
					<input type="text" name="tags" className="form-control" placeholder="e.g., MERN, Workshop, Free" value={formData.tags} onChange={handleChange} />
				</div>
